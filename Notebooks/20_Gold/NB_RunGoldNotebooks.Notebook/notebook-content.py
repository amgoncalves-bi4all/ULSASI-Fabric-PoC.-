...
silver_gold_config_path = f"abfss://{workspaceId}@onelake.dfs.fabric.microsoft.com/{gold_lakehouse_id}/Tables/config/silverGoldConfig"
silver_gold_dependency_path = f"abfss://{workspaceId}@onelake.dfs.fabric.microsoft.com/{gold_lakehouse_id}/Tables/config/silverGoldDependency"
...
groupedDF = result_df.groupby("notebookName", "destinationObjectPattern") \

...
tempTable = 'framework_temp_fact_full'
tableDest = 'framework.fact_full'
tablePathDest = f"abfss://{workspaceId}@onelake.dfs.fabric.microsoft.com/{gold_lakehouse_id}/Tables/framework/fact_full"

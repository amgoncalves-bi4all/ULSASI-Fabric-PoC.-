...
tempTable = 'framework_temp_fact_sales'
tableDest = 'framework.fact_sales'
tablePathDest = f"abfss://{workspaceId}@onelake.dfs.fabric.microsoft.com/{gold_lakehouse_id}/Tables/framework/fact_sales_delta"
...
sourceSalesFilteredDF = ProcessDelta(modelName = model, tableName = tableDest, DF = sourceSalesDF)
...
UpdateProcessingDate(modelName = model, tableName = tableDest, processingDate=f'{today}', scope='fact')

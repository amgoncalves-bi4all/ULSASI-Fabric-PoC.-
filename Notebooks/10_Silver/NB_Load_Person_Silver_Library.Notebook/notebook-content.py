...
sourceDF = commonlib.AddMetadataColumnsStandardizedLayer(newDataDF,loadType,KeyColumnList)            
# display(newDataDF)
...
if config_items.get("extractType")=='delta':
    ...
    commonlib.UpdateProcessingDate(modelName = modelName, tableName = objectName, processingDate=f'{today}', scope="silver")
